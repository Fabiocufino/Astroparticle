...
<div style="position: relative; width: 100%; height: 190px;">
  <span style="color: grey; position: absolute; top:330%; left: 30%; transform: translate(-50%, -50%); font-size: 18px;">
...
<div style="position: relative; width: 100%; height: 200px;">
  <span style="color: white; position: absolute; top:130%; left: 70%; transform: translate(-1%, -50%); font-size: 18px;">
    Consistent with position: Right Ascension (RA) 77.3582°, Declination (Dec) +5.69314°
  </span>
  <div style="position: absolute; top: 89%; left: 103%; width: 20px; height: 20px; background-color: white; border-radius: 40%; transform: translate(-50%, -50%);"></div>
</div>

. . .

<div style="position: relative; width: 100%; height: 200px;">
  <span style="color: white; position: absolute; top:50%; left: 70%; transform: translate(-1%, -50%); font-size: 18px;">
...
- **Location**: TXS 0506+056 is in the northern sky, observed through Earth by IceCube. <!-- .element: class="fragment" -->
- **Data Collection**: ~70,000 neutrino-induced muon tracks recorded annually. <!-- .element: class="fragment" -->

:::: {.columns}

::: {.column width="45%"}
<div class="fragment">
  <p><strong>Astrophysical Neutrinos:</strong></p>
  <ul>
    <li>Less than 1% of the detected events.</li>
    <li>Come from distant cosmic sources.</li>
    <li>Flux scales as $dN/dE \sim E^{-2}$.</li>
  </ul>
</div>
:::
...
::: {.column width="45%"}
<div class="fragment">
  <p><strong>Background Events:</strong></p>
  <ul>
    <li>Vast majority of detected events.</li>
    <li>Caused by neutrinos produced in the Earth's atmosphere.</li>
    <li>Flux scales as $dN/dE \sim E^{-3.7}$.</li>
  </ul>
</div>
:::
...
<div class="fragment">
  ...
  <p style="color: gray; font-size: 18px; margin-top: -20px; text-align: center;">[arXiv:1807.08794v1]</p>
...
<ul>
  <li class="fragment">IC86b from 2012 to 2015, contains a significant excess which is identified by both time-window shapes.</li>
  <li class="fragment">The excess consists of $13 \pm 5$ events above the expectation from the atmospheric background.</li>
</ul>
...
b. Skymap showing the p value of the time-dependent analysis performed at the coordinates of TXS 0506+056 (cross) and at surrounding locations, during IC86b data period.
...
<p style="position: absolute; bottom: 770px; left: 770px; color: gray; font-size: 18px; margin-top: 320px;">[arXiv:1807.08794v1]</p>

  <img src="Images/fig_4_b.png" alt="Plot" style="position: absolute; bottom: 1020px; left: 700px; width: 300px; height: 220px;">

  <div class="fragment">
  <img src="Images/fig_4.png" alt="Plot" style="position: absolute; bottom: 800px; left: 700px; width: 300px; height: 220px;">
  </div>
...
Denomination of Test Statistic (TS):
$$
L(\Phi_{100} = 0)?
$$
